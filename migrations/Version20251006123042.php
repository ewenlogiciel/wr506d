 ...
 */
final class Version20251006123042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD director_id INT DEFAULT NULL, ADD nb_entries INT DEFAULT NULL, ADD url VARCHAR(255) DEFAULT NULL, ADD budget DOUBLE PRECISION DEFAULT NULL');

...
class __TwigTemplate_e2b1df261100ecca8305fed7de649013 extends Template
{
    ...
    <h2>";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["slug"]) || array_key_exists("slug", $context) ? $context["slug"] : (function () { throw new RuntimeError('Variable "slug" does not exist.', 5, $this->source); })()), "html", null, true);
        yield "</h2>
";
...
{% block body %}
    ...
    <h2>{{ slug }}</h2>
{% endblock %}
", "product/list.html.twig", "/var/www/html/wr506d/wr506d/templates/product/list.html.twig");
    }
}
